"""
AGENT 3 — WRITER
Fixed prompt template use karo — TinyLlama se message personalize karo.
...
def _write_message(lead: dict, base_msg: str = None) -> str:
    ...
    Otherwise, use TinyLlama for AI personalization.
    """
    ...
    try:
        msg = generate_text(prompt, model=OLLAMA_MODEL)
